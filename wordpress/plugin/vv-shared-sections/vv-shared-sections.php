...
function vvss_enqueue_assets() {
	...
	$script = VVSS_DIR . 'assets/shared-section.js';
	if ( file_exists( $script ) ) {
		wp_enqueue_script( 'vvss-shared-section', VVSS_URL . 'assets/shared-section.js', array(), filemtime( $script ), true );
	}
}
